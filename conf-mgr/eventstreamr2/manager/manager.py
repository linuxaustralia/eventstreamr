...
from eventstreamr2.lib import general_commands
from eventstreamr2.lib.commands import ListenableConfiguredAMP
from eventstreamr2.lib.exceptions import InvalidConfigurationException
from eventstreamr2.lib.file_helper import load_json
import eventstreamr2.lib.manager.queue
from eventstreamr2.lib.manager.config_manager import StationConfigManager
from eventstreamr2.lib.manager.station_logs import StationLogReceiver
...
class StationInformation:
    def __init__(self, station_transport, station_config=None):
        ...
        :type station_config: eventstreamr2.lib.config.StationConfig
        """
...
class QueueManagerStation(MultiService):
    ...
    def __init__(self, queue_config):
        ...
        for queue_name, config in queue_config.iteritems():
            ...
            queue = eventstreamr2.lib.manager.queue.create_queue(_registered_stations, queue_name, station_config,
